...
namespace StockA
{
    class Order
    {
        ...
        void OnReceiveData(string tr_code) {
            ...
            */
            ...
            for (int i = 0; i <= nCount; i++) {
                ...
                this.output.Text += String.Format("주문번호 => {0} {1}:{2}:{3}",ord_num, ord_time.Substring(0,2), ord_time.Substring(2, 4), ord_time.Substring(4, 6)) + Environment.NewLine;
        ...
        public void request(string code, string price) {
            /*
